...
import { AddressDepth } from './select-address';

export default function NewDropdownSearch({
  address,
  depth,
  selectedAddress,
  setSelectedAddress,
  ...
  currentDepth: AddressDepth;
  setCurrentDepth: Dispatch<SetStateAction<AddressDepth>>;
}) {
  ...
  const handleVisible = useCallback(() => {
    switch (depth) {
      case 'li': {
        setVisible(currentDepth === depth);
        break;
      }
      case 'eupmyundong': {
        setVisible(currentDepth === depth || currentDepth === 'li');
        break;
      }
      case 'gungu': {
        setVisible(currentDepth === depth || currentDepth === 'eupmyundong' || currentDepth === 'li');
        break;
      }
      case 'sido': {
        setVisible(true);
  ...
  const handleSelectAddress = useCallback(
    ...
    [address, depth, selectedAddress, setSelectedAddress, setCurrentDepth]
  );
